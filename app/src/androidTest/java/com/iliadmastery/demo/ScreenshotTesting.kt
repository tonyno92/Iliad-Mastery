...
/**
 * this function called the first time will throw an exception because there is no screenshot in the resource folder,
 * called the second time will check if the screenshot in the asset is the same as the new generated one
 *
 * @param folderName: String directory to save the screenshot
 * @param goldenName: String name of screenshot
 * @param node: SemanticsNodeInteraction node you want in bitmap
 */
